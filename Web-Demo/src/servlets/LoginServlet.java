...
import utils.ServletsConstants;
import utils.SessionUtils;

import java.io.IOException;

import static utils.ServletsConstants.USERNAME;
            ...
            if (usernameFromParameter == null || usernameFromParameter.isEmpty()) {
                ...
                synchronized (this) {
                    if (userManager.isUserExists(usernameFromParameter)) {
                        ...
                        //create a new one
                        request.getSession(true).setAttribute(ServletsConstants.USERNAME, usernameFromParameter);
