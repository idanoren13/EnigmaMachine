...
public class ConfigurationInputWindowController implements Initializable {
    private final MachineConfigurationController machineConfigurationController;
    ...
    public ConfigurationInputWindowController(XMLLoader xmlLoader, MachineConfigurationController machineConfigurationController) {
