    ...
    private boolean initializeEnigmaCode(boolean isManual) {
        ...
        if (isManual) {
            ...
            if (isValidConfigurationTextFields()) {
                ...
                try {
                    AppController.initializeEnigmaCodeManually(rotors, startingPositions, plugBoardPairs, reflectorID);
...
//    }
    ...
    public void updateStylesheet(Number num) {
        ...
        if (num.equals(0)) {
            mainScrollPane.getStylesheets().add("/uBoatApp/frontEnd/css/screen1StyleOne.css");
            mainScrollPane.getStylesheets().add("/uBoatApp/frontEnd/css/generalStyleOne.css");
        } else if (num.equals(1)) {
            mainScrollPane.getStylesheets().add("/uBoatApp/frontEnd/css/screen1StyleTwo.css");
            mainScrollPane.getStylesheets().add("/uBoatApp/frontEnd/css/generalStyleOne.css");
        } else {
            mainScrollPane.getStylesheets().add("/uBoatApp/frontEnd/css/screen1StyleThree.css");
            mainScrollPane.getStylesheets().add("/uBoatApp/frontEnd/css/generalStyleOne.css");
        }
    }
}