...
public class Engine implements enigmaEngine.Engine {
    ...
    private final HashMap<Character, Reflector> reflectors; // From I to V
    private final PlugBoard plugBoard;

    public Engine(HashMap<Integer, Rotor> rotors, HashMap<Character, Reflector> reflectors, PlugBoard plugBoard) {
        this.rotors = rotors;
...
//    }
    ...
    public HashMap<Character, Reflector> getReflectors() {
        return reflectors;
    }
